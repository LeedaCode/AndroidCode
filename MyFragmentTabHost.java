package com.example.networkapp.Override;
...
public class MyFragmentTabHost extends TabHost
     ...
     */
    @Deprecated
    public MyFragmentTabHost(@NonNull Context context) {
     ...
     */
    @Deprecated
    public MyFragmentTabHost(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    ...
    //我重写了这个方法 ，试切换Tab时不再onAttch和onDetach，而是show or hide
    //参考 https://stackoverflow.com/questions/19331492/how-to-maintain-fragments-state-in-the-application
    @Nullable
...
//        final TabInfo newTab = getTabInfoForTag(tag);
        ...
        if(newTab ==null){
            throw new IllegalStateException("No tab know for tag "+tag);
        }
...
//                    ft.detach(mLastTab.fragment);
            ...
            if (newTab != null) {
                if (newTab.fragment == null ||newTab.fragment.getView() ==null) {
                    ...
                    if(newTab.fragment.isHidden()&&newTab.fragment.getView()!=null){
